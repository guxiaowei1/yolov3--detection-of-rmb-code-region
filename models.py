...
def create_grids(self, img_size, ng, device='cpu'):
 ...
 #    a, b = np.meshgrid(np.arange(nx), np.arange(ny))  # 生成网格点坐标矩阵
...
def load_darknet_weights(self, weights, cutoff=-1):
    ...
    # cutoff: save layers between 0 and cutoff (if cutoff = -1all are saved)
...
# module_defs = parse_model_cfg('cfg/yolov3-tiny.cfg')
#
# module_defs[0]['cfg'] = 'cfg/yolov3-tiny.cfg'
# module_defs[0]['height'] = 416
# a,module_list=create_modules(module_defs)
# print(module_list)
