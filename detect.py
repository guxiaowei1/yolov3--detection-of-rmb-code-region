    ...
    for i, (path, img, im0, vid_cap) in enumerate(dataloader):
        ...
        if detections is not None and len(detections) > 0:
            ...
            for *xyxy, conf, cls_conf, cls in detections:
                ...
                c1,c2 = plot_one_box(xyxy, im0, label=label, color=colors[int(cls)])
                print(c1)
                print(c2)
               # cv2.imwrite(save_path, im0[c1[1]:c2[1], c1[0]:c2[0]])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--images', type=str, default='data/samples/wei-img', help='path to images')
